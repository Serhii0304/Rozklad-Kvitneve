...
test('Minute-of-silence locks coexist with Pochuyki and prevent duplicate Kvitneve playback',async()=>{
 const descriptor=Object.getOwnPropertyDescriptor(globalThis,'navigator'),held=new Set(['pochuyki-minute-of-silence']);
 ...
 try{
  ...
  assert.ok(held.has('kvitneve-minute-of-silence'));assert.ok(held.has('pochuyki-minute-of-silence'));
