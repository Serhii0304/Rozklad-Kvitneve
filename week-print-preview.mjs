import {wholeWeekPosters,weekPosterForDay,wholeWeekPdfPath} from './week-posters.mjs?v=20260913-safe-print';
...
for(const [index,page] of pages.entries()){
 ...
 const preview=document.createElement('img');preview.src=page.printPreviewPath+'?v=20260913-schedule-1';preview.alt='Загальний розклад: '+page.label+', усі 5–11 класи';preview.width=1400;preview.height=990;preview.loading=index?'lazy':'eager';figure.append(preview);
 ...
 const download=document.createElement('a');download.href=page.printImagePath+'?v=20260913-schedule-1';download.download=page.downloadName;download.textContent='Зберегти PNG';
 ...
 original.src=page.imagePath+'?v=20260913-schedule-1';sheet.append(original);$('#week-print-area').append(sheet);sheets.set(page.dayId,{sheet,original});
}
