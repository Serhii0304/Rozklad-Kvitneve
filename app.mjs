...
$('#schedule-caption').textContent=(view==='week'?'Понеділок — п’ятниця':D[day].label)+(view==='day'&&day===today?' · Сьогодні':'')+' · '+(grade==='all'?'5–11 класи':grade+' клас');
