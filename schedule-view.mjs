...
export function classWeekMarkup(config,grade,today=-1){
  ...
  return '<div class="table-wrap class-week-wrap" tabindex="0" role="region" aria-label="Тижневий розклад: '+label+'. Таблицю можна гортати вбік."><table class="schedule-table week-matrix"><caption class="sr-only">'+label+' · Навчальний тиждень · І семестр 2026–2027</caption><thead><tr><th scope="col">Урок / час</th>'+days.map((d,i)=>'<th scope="col" data-day-head="'+i+'" class="'+(i===today?'is-today':'')+'">'+escapeHtml(d.label)+(i===today?'<small>СЬОГОДНІ</small>':'')+'</th>').join('')+'</tr></thead><tbody>'+bells.map(b=>'<tr data-week-row="'+b.lesson+'"><th scope="row"><span class="lesson-number">'+b.lesson+'</span><span class="lesson-time"><span class="time-start">'+b.start+'</span><span class="time-separator">–</span><span class="time-end">'+b.end+'</span></span><span class="row-state"></span></th>'+days.map((d,i)=>{
